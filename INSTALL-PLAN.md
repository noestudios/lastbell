...
> Repo is public; 0.1.2 is on PyPI via the tag (0.1.1 shipped Phase 3, 0.1.2 the text-message-first wizard + dashboard-led README). Earlier: Phase 1: package audit
